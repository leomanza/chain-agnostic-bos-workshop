...
const updateSwapButton = () => {
    ...
    if (limit && amountIn < limit) {
        ...
        State.update({
            swapButtonText: `Insufficient ${state.unwrap ? wrapTokenName : tokenName
                } Balance`,
        });
    }
};
...
const showMaxButton = (state.unwrap && Number(state.amountIn) !== Number(state.balanceWrapToken)) || (!state.unwrap && Number(state.amountIn) !== Number(state.balanceToken));
                        ...
                        <SwapDetailsContainer>
                            <SwapDetailsWrapper>
                                ...
                                {showMaxButton ? (
                                    <MaxButton onClick={() =>
                                        State.update({
                                            amountIn: state.unwrap ? state.balanceWrapToken : state.balanceToken
                                        })}
                                    >Max</MaxButton>
                                ) : null}
